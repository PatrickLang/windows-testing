...
if [[ -z $1 ]] || [[ -z $2 ]]; then
    ...
    echo
    echo "Note: SSH agent forwarding must be enabled for your current session to avoid password prompts"
    exit 1
fi

# This content should be kept consistent with loggather.ps1
